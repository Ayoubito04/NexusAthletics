    ...
    const planes = [
        {
            ...
            icono: 'leaf-outline',
            caracteristicas: [
                'Body Scanner (análisis corporal básico)',
        ...
        },
        {
            ...
            caracteristicas: [
                'Body Scanner Avanzado + Análisis Genético',
                'Rutinas creadas según tu composición corporal',
                'Macros · RIR · Tempo · Tiempo de descanso',
                'Periodización 4 semanas con progresión IA',
                'Suplementación personalizada por IA',
                'Rutinas avanzadas con IA (Ultimate exclusivo)',
            ],
        },
    ];
